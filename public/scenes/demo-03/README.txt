...
4. Or open the pretty scene URL:
   ...
   If you want phone tilt / gyroscope interaction inside an iframe, keep accelerometer and gyroscope in the allow list.

iframe example:
<iframe src="https://your-cdn.example/path/to/scene-folder/" width="100%" height="700" style="border:0;" allow="autoplay; fullscreen; accelerometer; gyroscope"></iframe>